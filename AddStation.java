	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==button3)
		{
			if(!text1.getText().equals("") && table2.getSelectedRows().length > 0 && select1>0 && text1.getText().equals(newStation) && select2==1)
			{
				...
				try{
			Scanner sc=new Scanner(new File("files/temp1.txt"));
			...
			{
					try{
			Scanner sca=new Scanner(new File("files/temp2.txt"));
		...
		if(e.getSource()==button4)
		{
			...
			if(option == JOptionPane.YES_OPTION){
				...
				try{
							 ...
							 File newFile =new File("files/temp2.txt");
		...
		if(e.getSource()==button6)
		{
			...
			!text3.getText().equals(""))
			{
				...
				try{
			Scanner sc=new Scanner(new File("files/temp2.txt"));
			...
			{
					try{
			Scanner sca=new Scanner(new File("files/temp1.txt"));
			while(sca.hasNextLine())
			{
				String spl[]=sca.nextLine().split("/");
		...
		if(e.getSource()==button9)
		{
			...
			if(s6.equals(fromStation2) && s7.equals(toStation2))
			{
					try{
			Scanner sca=new Scanner(new File("files/temp1.txt"));
			while(sca.hasNextLine())
		...
		else if(!text1.getText().equals(newStation))
		{
			...
			JOptionPane.showMessageDialog(this,"You must have to Add Class","Error",JOptionPane.ERROR_MESSAGE);
		}
		...
		if(e.getSource()==button10)
		{
			...
			if(option == JOptionPane.YES_OPTION){
				...
				try{
					 ...
					 File newFile =new File("files/temp4.txt");
					newFile.createNewFile();
					FileWriter fw = new FileWriter(newFile,true);
					 
					 try{
			Scanner sc=new Scanner(new File("files/temp3.txt"));
			while(sc.hasNextLine())
			{
				String sp[]=sc.nextLine().split("/");
				...
				{
				     String	sttr = sp[0]+"/"+sp[1]+"/"+sp[2]+"/"+sp[3]+"/"+radiobtn1.getText()+"/"+text2.getText()+"\n"; 
					 TrainHistory history =new TrainHistory(sp[0],sp[1],sp[2],sp[3],radiobtn3.getText(),Double.parseDouble(text2.getText()));
		...
		else if(radiobtn2.isSelected())
		{
			...
			while(sc.hasNextLine())
			{
				...
				(sp[1].equals(toStation2) && sp[2].equals(fromStation2)))
				{
				     String	sttr = sp[0]+"/"+sp[1]+"/"+sp[2]+"/"+sp[3]+"/"+radiobtn2.getText()+"/"+text2.getText()+"\n"; 
					 TrainHistory history =new TrainHistory(sp[0],sp[1],sp[2],sp[3],radiobtn3.getText(),Double.parseDouble(text2.getText()));
					 historyList.insertHistory(history);
					 FileIO.readFromTrainHistoryFile("files/TrainHistory.txt",historyList);
						s6=fromStation2;
		...
		else if(radiobtn3.isSelected())
		{
			...
			while(sc.hasNextLine())
			{
				...
				(sp[1].equals(toStation2) && sp[2].equals(fromStation2)))
				{
				     String	sttr = sp[0]+"/"+sp[1]+"/"+sp[2]+"/"+sp[3]+"/"+radiobtn3.getText()+"/"+text2.getText()+"\n"; 
					 TrainHistory history =new TrainHistory(sp[0],sp[1],sp[2],sp[3],radiobtn3.getText(),Double.parseDouble(text2.getText()));
					 historyList.insertHistory(history);
					 FileIO.readFromTrainHistoryFile("files/TrainHistory.txt",historyList);
						s6=fromStation2;
